...
def _to_openai_message(msg: Message) -> dict[str, Any]:
    """Convert a Message to OpenAI chat format, attaching any images as
    image_url content parts (vision)."""
    if not msg.images:
...
class OpenAIProvider:
    ...
    async def complete(
        ...
        **kwargs: Any,
        ...
        openai_messages = [_to_openai_message(msg) for msg in messages]
